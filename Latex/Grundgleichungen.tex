...
\begin{align}
	\label{GSQV1} q_{x} &= p_{0x} + \bm{\lambda} \cdot p_{10x} + \bm{\mu} \cdot p_{20x} + \bm{\lambda}\bm{\mu} \cdot p_{\varnothing x} \\
	\label{GSQV2} q_{y} &= p_{0y} + \bm{\lambda} \cdot p_{10y} + \bm{\mu} \cdot p_{20y} + \bm{\lambda}\bm{\mu} \cdot p_{\varnothing y} \\
	\label{GSQV3} \bm{q_{z}} &= p_{0z} + \bm{\lambda} \cdot p_{10z} + \bm{\mu} \cdot p_{20z} + \bm{\lambda}\bm{\mu} \cdot p_{\varnothing z}
\end{align}
