...
\begin{align}
	\label{lambdaqD}
	\lambda_{q} &= \frac{p_{31x} \cdot qp_{1y} - p_{31y} \cdot qp_{1x}}{p_{31x} \cdot p_{21y} - p_{31y} \cdot p_{21x}} = \frac{(\vec{p}_{31} \times \vec{qp}_{1})_{z}}{(\vec{p}_{31} \times \vec{p}_{21})_{z}}
	\\
	\nonumber \\
	\label{muqD}
	\mu_{q} &= \frac{p_{21x} \cdot qp_{1y} - p_{21y} \cdot qp_{1x}}{p_{21x} \cdot p_{31y} - p_{21y} \cdot p_{31x}}
\end{align}
